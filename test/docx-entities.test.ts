...
test('a numeric character reference past the last code point stays text', async () => {
  ...
  // import. A document can carry them innocently - they are text, not markup.
  ...
  assert.equal(result.markdown, 'Hex &#x110000; and dec &#99999999; stay');
});
