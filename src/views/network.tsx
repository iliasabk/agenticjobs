        ...
        {result.jobs.length === 0 ? (
          ...
          <ul class="job-list">
            {result.jobs.map((entry) => {
              // Same badge as the local job card: current pay terms first,
              // the legacy salary range only for boards that serve nothing
              // newer, and nothing at all when the listing says nothing.
